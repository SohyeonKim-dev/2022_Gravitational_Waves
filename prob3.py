...
strain = frame.read_frame("BNS1-H1.gwf","H1:HWINJ_INJECTED")
...
for i in range(5):
    ...
    for j in range(800):
        ...
        hp, hc = get_td_waveform(approximant="SEOBNRv4_opt", mass1=m, mass2=m, 
                                lambda1= lambda_, lambda2 = lambda_,
                                delta_t=conditioned.delta_t, f_lower=30)
        ...
        if abs(snrp) > 10:
            print("We found a signal at {}s with SNR {} m:{} lambda:{}".format(time, abs(snrp), m, lambda_))
